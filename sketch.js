...
function draw() {
  ...
  if (gameState===PLAY){
   ...
   console.log(kangaroo.y)
    ...
    //establece la velocidad de cada objeto del juego a 0
    ...
    //establece el ciclo de vida de los objetos del juego para que no sean destruidos
...
function spawnShrubs() {
  ...
  if (frameCount % 150 === 0) {
    ...
    //asigna escala y ciclo de vida al arbusto           
    shrub.scale = 0.05;
